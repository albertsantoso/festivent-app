            ...
            <div className="SearchBar">
                <div className="search-bar-container flex justify-center">
                    <div className=" flex items-center relative">
                        ...
                        <input type="text" className="font-bold text-xl outline-none py-6 px-16 rounded-lg w-[560px] h-[64px] placeholder:text-white" placeholder="What do you want to see live?" />
                    </div>
                </div>
            </div>
        </>
