...
export default function EventDetailPage() {
    ...
    useEffect(() => {
        if (event) {
            ...
            const dateStartShort = new Date(event.datetime_start[0]).toLocaleDateString(undefined, {
                weekday: "short",
                month: "long",
                day: "numeric",
            });
                                ...
                                <div className="event-details">
                                    <div className="event-hero-wrapper py-4 md:py-12">
                                        <div className="event-hero">
                                            <img src={`${event.image}`} alt="" className="md:max-w-[1100px] md:min-w-[1080px] md:mx-auto" />
                                        </div>
                                    </div>
                                        ...
                                        <div className="event-details-main text-left col-span-4 max-w-[720px]">
                                            <div className="event-details-main-heading main-inner ff-space-g">
                                                <section className="event-details-head mb-8  md:mb-12">
                                                    <div id="time" className="font-semibold text-xl md:text-2xl text-neutral-700 mb-2">
                                                        {dayShort}
                                                    </div>
                                                ...
                                                <section className="organizer-info flex justify-between items-center bg-gradient-to-r from-blue-50 to-green-50 py-4 px-6 w-full rounded-lg mb-10 md:mb-16">
                                                    ...
                                                    <div className="organizer-account-follow justify-self-end w-[80px]">
                                                        ...
                                                        <PrimaryButton bgColor={"black"} buttonText={"Follow"} customStyle={"hover:scale-[1.04] active:scale-[.95]"} />
                                                    </div>
                                                </section>
                                            </div>
                                                                            ...
                                                                            <span>
                                                                                {
                                                                                    dateStart === dateEnd ?
                                                                                        (
                                                                                            <>
                                                                                                {dateStart} · {event.datetime_start[1]} - {event.datetime_end[1]}
                                                ...
                                                <div className="price-get-tickets-inner flex flex-col p-6 pb-10 md:p-6 text-neutral-700">
                                                    <div className="price-bar flex justify-between items-end">
                                                        ...
                                                        <span className="flex items-end">
                                                            <h3 className="font-bold text-xl">{event.price === 0 ? "Free" : event.price.toLocaleString("id-ID", { style: "currency", currency: "IDR", minimumFractionDigits: 0 })}</h3>
                                                        </span>
                                                    </div>
                                                                    ...
                                                                    <div className="panel-right-content ">
                                                                        <aside className="">
                                                                            ...
                                                                            <div className="order-summary-wrapper p-6 md:p-8">
                                                                                <h2 className="order-summary-event-title ff-space-g font-bold text-lg mb-6 md:block hidden">{event.title}</h2>
                                                    ...
                                                    <Modal.Body className="md:p-12">
                                                        <div className="modal-body-container">
                                                            <div className="modal-panel-wrapper ff-inter text-center">
                                                                <h1 className="text-xl md:text-4xl font-bold ff-space-g bg-green-400 py-4 md:py-8 rounded-lg mb-8 md:mb-12 text-white">Successfully Registered</h1>
                                                                <h2 className="text-xl md:text-2xl font-bold">{loggedInUser.fullname}</h2>
                                                                <h3>
                                                                    for <span className="text-xl md:text-2xl font-bold">{event.title}</span>
                                                                </h3>
                                                                <h3 className="mb-4 md:mb-12">
                                                                    on <span className="text-xl md:text-2xl font-bold">{date}</span>{" "}
                                                                </h3>
                                                                {event.price === 0 ? null : (
                                                                    <>
                                                                        <h3 className="text-lg md:text-xl font-medium mb-2">Here is your referral code:</h3>
                                                                        <h1 className="text-4xl md:text-7xl font-bold mb-12">{newRefCode}</h1>
                                                                    </>
                                                                )}

                                                                <h2 className="font-medium text-lg mb-8 md:text-2xl">See you on the event! Thank you!</h2>

                                                                <div className="md:hidden flex justify-center items-center gap-[4px] text-xl"
                                                                    onClick={() => {
                                                                        setOpenModal(undefined)
                                                                        window.location.reload(false);
                                                                    }}>
