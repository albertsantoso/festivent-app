                    ...
                    <div className="login-section w-[50%] h-[100vh]">
                        <div className="login-section-container px-72 py-44 h-full ">
                            ...
                            <div className="split-form my-8">
                                <span className="pill border-2 px-4 py-[2px] rounded-full text-sm text-center font-medium text-gray-400">or</span>
                            </div>
                            ...
                            <div className="create-account text-left">
                                <span className="font-medium">Don't have an account? <Link to={"/signup"}><span className="text-blue-500">Sign up</span></Link> </span>
                            </div>
                        </div>
                    </div>
